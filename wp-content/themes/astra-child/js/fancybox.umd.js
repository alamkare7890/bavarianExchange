    ...
    , z = function(t) {
      ...
      return s(n, [{
          ...
          value: function() {
              ...
              (i = n).append.apply(i, g(t.childNodes)),
              t.appendChild(n));
    ...
    , M = function() {
      ...
      return s(t, [{
          ...
          value: function(t) {
              ...
              return (e = n.classList).add.apply(e, g(o.split(" "))),
      ...
      return s(n, [{
          ...
          value: function() {
              ...
              r.forEach((function(t) {
                  ...
                  m.indexes = [].concat(g(m.indexes), g(e.indexes))) : (e.index = y.length,
                  m = e,
                  y.push(e))
              }
              )),
    ...
    , J = function() {
      ...
      return s(t, [{
          ...
          value: function(t) {
              ...
              return t.label && e.setAttribute("title", this.fancybox.localize("{{".concat(t.label, "}}"))),
    ...
    , it = function(t) {
      ...
      return s(i, [{
          ...
          value: function() {
              ...
              this.id || (this.id = this.options.id || ++et,
          ...
          value: function(t, e) {
              ...
              if (e instanceof HTMLElement ? ["img", "iframe", "video", "audio"].indexOf(e.nodeName.toLowerCase()) > -1 ? (i = document.createElement("div")).appendChild(e) : i = e : (i = document.createElement("div")).innerHTML = e,
              !(i instanceof Element))
                  throw new Error("Element expected");
              return t._className = "has-".concat(n.suffix || t.type || "unknown"),
              o.classList.add(t._className),
              i.classList.add("fancybox__content"),
              "none" !== i.style.display && "none" !== window.getComputedStyle(i).getPropertyValue("display") || (i.style.display = t.display || this.option("defaultDisplay") || "flex"),
          ...
          value: function(t) {
              ...
              !(["closing", "customClosing", "destroy"].indexOf(this.state) > -1) && !1 !== this.trigger("shouldClose", t) && (this.state = "closing",
